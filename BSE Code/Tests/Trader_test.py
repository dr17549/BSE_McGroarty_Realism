...
#
    ...
    #     exchange.asks = Orderbook_half('asks', 1)
    #     exchange.bids = Orderbook_half('bids', 100)
    #     order00 = Order('T01', 'Bid', 11, 100, 1, 0, 'LIM')
    #     order01 = Order('T01', 'Ask', 9, 100, 1, 0, 'LIM')
    #     exchange.add_order(order00, False)
    #     exchange.add_order(order01, False)
    #     lob = exchange.publish_lob(1, False)
    #     print(lob)
    ...
    #     market01.mr = 1
    #     market01.update_best_prices(lob)
    #     print(market01.best_ask)
    #     print(market01.best_bid)
    #     tempord = Order('T01', 'Ask', 10, 1, 1, 0, 'LIM')
    #     market01.add_order(tempord, False)
    #
    #     orders, del_orders = market01.getorder(20, 2, lob)
    ...
    #     self.assertEqual(orders[0].price , 9)
    #
    ...
    def test_mr_getorder_03(self):
        ...
        exchange.asks = Orderbook_half('asks', 1)
        exchange.bids = Orderbook_half('bids', 100)
        order00 = Order('T06', 'Bid', 11, 1, 1, 0, 'LIM')
        order01 = Order('T05', 'Ask', 9, 1, 1, 0, 'LIM')
        order02 = Order('T03', 'Bid', 6, 1, 1, 0, 'LIM')
        order03 = Order('T04', 'Ask', 4, 1, 1, 0, 'LIM')
        exchange.add_order(order00, False)
        exchange.add_order(order01, False)
        lob = exchange.publish_lob(1, False)
